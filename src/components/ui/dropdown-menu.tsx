...
const DropdownMenuItemVariants = cva(
  "relative flex cursor-pointer select-none item-center rounded-sm px-2 py-1.5 text-sm outline-none transition-colors data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
  {
    variants: {
      variant: {
